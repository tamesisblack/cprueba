	...
	<div class="row">
		...
		<table WIDTH=100%>
			...
			<tr>
				...
				<td width=10%  align="right">{{ $d->TotalExtendedAmt }}</td>
			</tr>
			<tr class="sinbordes">
				<td width=10%  align="left"> </td>
				...
				<td width=10%  align="right"> {{ $d->sucursal->label_tax_code }} {{ $d->tax_value * 100 }} %</td>
				...
				<td width=10%  align="right">  {{ round ( $d->TotalExtendedAmt  + $d->TaxAmt  , 2)}} </td>
			</tr>

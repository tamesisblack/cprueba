        ...
        <div class="panel with-nav-tabs panel-info">
            <div class="panel-heading">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a data-toggle="tab" href="#tab1default">Principal</a>
                    </li>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('list_price_per_unit', null, ['class' => 'form-control', 'placeholder' => '']) !!}
                                    </div>
                                    <div class="form-group">
					...
					<div class="tab-pane fade" id="tab8default">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <button type="button" class="btn btn-primary mb-2" onclick="agregarComponente()">
										...
										<div class="filter-container p-0 row">
											<div class="filtr-item col-sm-4">
												<a class="btn" onclick="imagen(1)">
													<img width="200px" height="200px" id='img_1' src="{{$rsitems->name_img != null ?  url('img_articulos/'.$rsitems->name_img) : url('img/sin_imagen_disponible.jpg')}}" class="img-fluid mb-2" alt="white sample">

...
<head>
    ...
    <style>
        body {
            font-family: 'Lato';
            background-image: url("img/bg-mainPROD-OLD.jpg");
    ...
    <!--
     <link rel="stylesheet" href="{{asset('plugins/material/dist/css/bootstrap-material-design.min.css')}}">
    -->
</head>
<body id="app-layout">
    ...
    <script type="text/javascript" src="{{asset('plugins/material/dist/js/material.min.js')}}" ></script>

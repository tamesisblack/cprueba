...
return [
    ...
    */
    'attributes' => [
        'trx_number' => 'número de factura',
        'class_code' => 'clase',
        'trx_date' => 'fecha',
        'invoice_currency_code' => 'moneda',
        'bill_to_customer_id' => 'facturación / cliente',
        'ship_to_customer_id' => 'envío / cliente',
        'salesrep_id' => 'vendedor',   
        'receipt_number' => 'Número de recibo',
        'amount' => 'Importe',
        'type' => 'Tipo',
        'pay_from_customer' => 'Cliente',
        'class_trx' => 'Número de factura y clase',
    ],
];